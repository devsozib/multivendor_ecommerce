...
class BrandController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($status){
              return redirect()->route('brand.index')->with('success', 'Yes! Brand Added Success');
        }
        else{
    ...
    public function update(Request $request, $id)
    {
        ...
        if($brand){
            ...
            if($status){
                  return redirect()->route('brand.index')->with('success', 'Yes! Brand updated Success');
            }
            else{
                return back()->with('error','Something is wrong please cheak and try again');
            }
    ...
    public function destroy($id)
    {
        ...
        if($brand){
           $status = $brand->delete();
           if($status){
               return redirect()->route('brand.index')->with('success','Yes! Brand Deleted Successfull');
           }
           else{
