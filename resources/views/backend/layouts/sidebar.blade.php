            ...
            <div class="tab-pane active" id="menu">
                <nav id="left-sidebar-nav" class="sidebar-nav">
                    <ul id="main-menu" class="metismenu">                            
                        ...
                        <li>
                            <a href="#App" class="has-arrow"><i class="icon-basket-loaded"></i> <span>Cart Mangement</span></a>
                            <ul>
                                <li><a href="app-inbox.html">Inbox</a></li>
                        ...
                        <li>
                            <a href="#App" class="has-arrow"><i class="icon-layers"></i> <span>Order Mangement</span></a>
                            <ul>
                                <li><a href="app-inbox.html">Inbox</a></li>
                        ...
                        <li>
                            <a href="#App" class="has-arrow"><i class="icon-grid"></i> <span>Order Mangement</span></a>
                            <ul>
                                <li><a href="app-inbox.html">Inbox</a></li>
                        ...
                        <li>
                            <a href="#App" class="has-arrow"><i class="icon-organization"></i> <span>Post Category</span></a>
                            <ul>
                                <li><a href="app-inbox.html">Inbox</a></li>
                        ...
                        <li>
                            <a href="#App" class="has-arrow"><i class="fas fa-newspaper"></i> <span>Post Management</span></a>
                            <ul>
                                <li><a href="app-inbox.html">Inbox</a></li>
                        ...
                        <li>
                            <a href="#App" class="has-arrow"><i class="icon-check"></i> <span>Coupon Management</span></a>
                            <ul>
                                <li><a href="app-inbox.html">Inbox</a></li>
                        ...
                        <li>
                            <a href="#App" class="has-arrow"><i class="icon-people"></i> <span>User Management</span></a>
                            <ul>
                                <li><a href="app-inbox.html">Inbox</a></li>
                        ...
                        <li>
                            <a href="#App" class="has-arrow"><i class="icon-bubbles"></i> <span>Comment Management</span></a>
                            <ul>
                                <li><a href="app-inbox.html">Inbox</a></li>
